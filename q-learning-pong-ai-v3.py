...
class PongGame(pyglet.window.Window):
    ...
    def __init__(self):
        ...
        #self.ai1.speed = 18 # comment after debugging.
    ...
    def play(self, winning_score=11, qlearn_mode=False):
        ...
        while self.ai1.score < winning_score and self.ai2.score < winning_score:
            ...
            # if qagent_curr_state > self.qagent_action:
            #     self.ai1.y -= self.ai1.speed
            # elif qagent_curr_state < self.qagent_action:
            #     self.ai1.y += self.ai1.speed
            # print(self.qagent_action)
...
class Qagent():
    ...
    def qlearn(self, ball_y, pad_y):
        ...
        #self.epsilon = max(0.01, round(1 - self.opponent.score/self.pong_game.winning_score, 2))
        ...
        if rand_num < self.epsilon:  # exploration. Always true if rand_num = 0 and self.epsilon = 1
            ...
            next_state_q_values = self.qtable[ball_y][pad_y]
    ...
    def play_game(self, ball_y, pad_y):
        ...
        return self.pad_actions[best_next_state]
