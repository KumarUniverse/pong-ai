        ...
        while True: #self.ai1.score < winning_score and self.ai2.score < winning_score:
            ...
            if self.ball.y <= self.ai1.y + self.ai1.height and \
                ...
                if self.ball.x <= self.ai1.x + self.ai1.width and \
                    ...
                    reward_weight = (self.ai1.height // 2) - abs_diff
                    reward_weight = max(0, reward_weight)
            ...
            # If a reward is not already given, give it an absolute difference reward.
            if reward == 0:
                ball_center = (self.ball.y + self.ball.y + self.ball.height) // 2
                pad_center = (self.ai1.y + self.ai1.y + self.ai1.height) // 2
                abs_diff = abs(ball_center - pad_center)
...
class Qagent():
    ...
    def __init__(self, pong_game, paddle, episode_limit):
        ...
        , dtype=np.int32) # dimensions: 166x233x4
    ...
    def create_q_model(self):
        ...
        layer3 = layers.Conv2D(20, 4, strides=(2,2), activation="relu")(inputs) #(inputs)
        layer4 = layers.Conv2D(10, 8, strides=(4,4), activation="relu")(layer3)
        layer5 = layers.Flatten()(layer4) # works better with square images.
        layer6 = layers.Dense(6, activation="relu")(layer5)
        ...
        action_layer = layers.Dense(num_pad_actions, activation="linear")(layer6)
